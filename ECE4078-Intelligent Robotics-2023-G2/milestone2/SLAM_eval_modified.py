...
if __name__ == '__main__':
    ...
    # gt_aruco = parse_groundtruth(args.groundtruth)  # only got 2 groundtruth marker positions
    # us_aruco = parse_user_map(args.estimate)  # all 10 estimated marker positions
    # print(gt_aruco)
    gt_aruco = {
        3: np.array([0.0, 1.2]).reshape(2,1),
        7: np.array([1.2, 0.0]).reshape(2,1)
    }
    us_aruco = {
        3: np.array([1.713806899056723, 1.4599192582350562]).reshape(2,1),
        7: np.array([1.1239239639529641, -0.11468081893338948]).reshape(2,1)
    }
    ...
    gt_aruco_full ={
        1: {np.array([-0.8, 1.2]).reshape(2,1)},
        2: {np.array([-0.4, 1.2]).reshape(2,1)},
        3: {np.array([0.0, 1.2]).reshape(2,1)},
        "aruco4_0": {
            "x": -1.2,
            "y": 0.8
