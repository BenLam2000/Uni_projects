...
def calibrateWheelRadius():
    ...
    ##########################################
    # wheel_velocities_range = [10, 15, 20, 25]  # or use np.linspace
    wheel_velocities_range = [20, 25]  # or use np.linspace
    delta_times = []
    ...
    for delta_time, wheel_vel in zip(delta_times, wheel_velocities_range):
        ...
        scale += (1/num)*(1/delta_time)/wheel_vel
...
def calibrateBaseline(scale):
    ...
    # Feel free to change the range / step
    ##########################################
    wheel_velocities_range = [15, 20, 25]  # or use np.linspace
    delta_times = []
